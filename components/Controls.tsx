          ...
          >
            ...
            {week === currentAcademicWeek && (
              <span className="absolute -top-1.5 -right-1.5 flex h-4 w-4">
                <span className="relative inline-flex rounded-full h-4 w-4 bg-indigo-500 border-2 border-white text-white text-[10px] items-center justify-center font-bold leading-none">
                  !
                </span>
              </span>
            )}
