...
export const FIT_3_6_1_6sem_2025_SCHEDULE: Schedule = {
    monday: [
        {
            time: '08:00 - 09:25',
            details: { name: 'Программирование серверных кроссплатформенных приложений', type: 'Лабораторная', location: '324-1', instructor: 'Сазонова Д.В.' }
        },
        {
            time: '09:35 - 11:00',
    ...
    thursday: [
        {
            time: '08:00 - 09:25',
            details: { name: 'Проектирование и разработка баз данных интернет-приложений', type: 'Лабораторная', location: '308-1', instructor: 'Нистюк О.А.' }
        },
        {
            time: '09:35 - 11:00',
            details: { name: 'Администрирование и безопасность интернет систем', type: 'Лабораторная', location: '309-1', instructor: 'Сазонова Д.В.' }
        },
        {
            time: '11:25 - 12:50',
