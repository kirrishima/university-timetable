...
export const FIT_4_6_1_7sem_2026_SCHEDULE: Schedule = {
    monday: [
        {
            time: '08:00 - 09:25',
    ...
    tuesday: [
        ...
        {
            time: '11:25 - 12:50',
            details: { name: 'Программирование мобильных приложений', type: 'Лабораторная', location: '204-1' }
        },
        {
            time: '13:00 - 14:25',
            weeks: {
                [WeekType.FIRST]: { name: 'Распределённые и облачные технологии', type: 'Лабораторная', location: '209-1' },
                [WeekType.SECOND]: { name: 'Интеллектуальная обработка и анализ данных', type: 'Лабораторная', location: '322-1' },
            },
        },
    ],
    wednesday: [
        {
            time: '08:00 - 09:25',
            weeks: {
                [WeekType.FIRST]: { name: 'Программирование мобильных приложений', type: 'Лабораторная', location: '204-1' },
            },
        },
        {
            time: '09:35 - 11:00',
    ...
    thursday: [
        {
            time: '08:00 - 09:25',
            details: { name: 'Корпоративные информационные системы', type: 'Лабораторная', location: '204-1' }
        },
        {
            time: '09:35 - 11:00',
        ...
        {
            time: '11:25 - 12:50',
            details: { name: 'Программирование веб-сервисов', type: 'Лабораторная', location: '' }
        },
    ],
    friday: [
        {
        ...
        {
            time: '09:35 - 11:00',
            details: { name: 'Распределённые и облачные технологии', type: 'Лабораторная', location: '209-1' }
        },
        {
            time: '11:25 - 12:50',
            weeks: {
