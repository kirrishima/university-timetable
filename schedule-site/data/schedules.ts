...
import { FIT_4_6_2_7sem_2026_SCHEDULE } from './FIT_4_6_2_7sem_2026_SCHEDULE';
import { FIT_4_6_1_7sem_2026_SCHEDULE } from './FIT_4_6_1_7sem_2026_SCHEDULE';
...
export const ALL_SCHEDULES: ScheduleEntry[] = [
  ...
  },
  {
    ...
    group: 6,
    subgroup: 2,
    schedule: FIT_4_6_2_7sem_2026_SCHEDULE,
    universityName: 'БГТУ',
    semester: 'Осенний'
  },
  {
    ...
    group: 6,
    subgroup: 1,
    schedule: FIT_4_6_1_7sem_2026_SCHEDULE,
    universityName: 'БГТУ',
    semester: 'Осенний'
  }
];
