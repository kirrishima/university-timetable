  ...
  indigo: {
    ...
    colors: {
      ...
      classType: {
        ...
        elective: "bg-amber-50 text-amber-800 border border-dashed border-amber-400",
      },
  ...
  rose: {
    ...
    colors: {
      ...
      classType: {
        ...
        elective: "bg-orange-50 text-orange-800 border border-dashed border-orange-400",
      },
  ...
  amber: {
    ...
    colors: {
      ...
      classType: {
        ...
        lab: "bg-yellow-100 text-yellow-800",
        elective: "bg-white text-amber-900 border border-dashed border-amber-600",
      },
      divider: "border-stone-200",
      navBarBg: "bg-white/80",
    },
  ...
  slate: {
    ...
    colors: {
      ...
      classType: {
        ...
        elective: "bg-slate-800 text-amber-300 border border-dashed border-amber-600",
      },
